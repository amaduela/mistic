...
<?php } else { ?>
            ...
            <div class="images gbtr_images">
               ...
               <!-- <div class='doubleSlider-1'>-->
                    ...
                    <div id="sync1" class="slider product_images doubleSlider-1 woocommerce-product-gallery__wrapper<?php echo $slider_class; ?>">
                        ...
                        <div class="item woocommerce-product-gallery__image">
                            ...
                            <?php if (!isset($theretailer_theme_options['product_image_zoom']) || ($theretailer_theme_options['product_image_zoom'] != 1)) : ?>
                        ...
                        <?php
                            ...
                            if ( $attachment_ids ) {
                                ...
                                foreach ( $attachment_ids as $attachment_id ) {
									...
									if (!isset($theretailer_theme_options['product_image_zoom']) || ($theretailer_theme_options['product_image_zoom'] != 1)) {
