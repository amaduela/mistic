...
$of_options[] = array( "name" 		=> "Product image zoom",
						"desc" 		=> "<strong>Enable</strong> / <strong>Disable</strong> the lightbox for product images.",
...
$all_font_faces = array('arial'=>'Arial',
				'Radnika Next Alt'		=> 'Radnika Next Alt',
				'HK Nova' 				=> 'HK Nova',
